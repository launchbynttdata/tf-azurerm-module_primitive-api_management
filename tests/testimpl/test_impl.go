...
func TestComposableApiManagementReadOnly(t *testing.T, ctx types.TestContext) {
	...
	expectedName := terraform.Output(t, ctx.TerratestTerraformOptions(), "api_management_name")
	expectedId := terraform.Output(t, ctx.TerratestTerraformOptions(), "api_management_id")
